...
public class MainImageActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void uploadImage(){
        ...
        uploadTask.addOnSuccessListener(taskSnapshot -> reference.child(pathFile).getDownloadUrl().addOnSuccessListener(uri -> {
            String downloadURL = uri.toString();
            databaseReference.child("image").push().setValue(new ModelsImage(downloadURL));
            progressBar.setVisibility(View.GONE);
            Toast.makeText(getApplicationContext(), "Uploading Berhasil!!", Toast.LENGTH_SHORT).show();
            finish();
